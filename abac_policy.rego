...
# Alternative path for less-than operator
allow {
    # Get user data
    user := data.users[input.user.key]
    ...
    # Check resource conditions for less-than
    resource_condition.operator == "less-than"
    to_number(resource_attr_value) < to_number(resource_condition.comparison_value)
}

# Alternative path for greater-than-or-equals operator
allow {
    # Get user data
    user := data.users[input.user.key]
    ...
    # Check resource conditions for greater-than-or-equals
    resource_condition.operator == "greater-than-or-equals"
    to_number(resource_attr_value) >= to_number(resource_condition.comparison_value)
}
